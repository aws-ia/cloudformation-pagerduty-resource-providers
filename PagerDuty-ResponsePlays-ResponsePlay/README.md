...
1. Write the JSON schema describing your resource, [pagerduty-responseplays-responseplay.json](./pagerduty-responseplays-responseplay.json)
2. Implement your resource handlers in [handlers.ts](./pagerduty-responseplays-responseplay/handlers.ts)

> Don't modify [models.ts](./pagerduty-responseplays-responseplay/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
