...
1. Write the JSON schema describing your resource, [pagerduty-teams-team.json](./pagerduty-teams-team.json)
2. Implement your resource handlers in [handlers.ts](./pagerduty-teams-team/handlers.ts)

> Don't modify [models.ts](./pagerduty-teams-team/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
