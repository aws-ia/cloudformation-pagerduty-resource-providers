...
1. Write the JSON schema describing your resource, [pagerduty-services-service.json](./pagerduty-services-service.json)
2. Implement your resource handlers in [handlers.ts](./pagerduty-services-service/handlers.ts)

> Don't modify [models.ts](./pagerduty-services-service/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
