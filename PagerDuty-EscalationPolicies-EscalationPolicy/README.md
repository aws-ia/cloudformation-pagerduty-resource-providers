...
This resource type manages a [PagerDuty EscalationPolicy][1]
...
3. Use the search bar to filter by the "PagerDuty::EscalationPolicies::EscalationPolicy" prefix.
...
### Shows how to set EscalationPolicy in PagerDuty.
```yaml
---
      ...
      EscalationRules:
        ...
        - Targets:
            - Id: 654321
              Type: user_reference
```
[1]: https://support.pagerduty.com/docs/escalation-policies
[2]: ./docs/README.md
