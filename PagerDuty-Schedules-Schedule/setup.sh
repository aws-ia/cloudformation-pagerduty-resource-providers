...
cat example_inputs/inputs_1_update.json | sed "s/PAGER_DUTY_TEAM_ID/${PAGER_DUTY_TEAM_ID}/g" | sed "s/PAGER_DUTY_USER_ID/${PAGER_DUTY_USER_ID}/g" > inputs/inputs_1_update.json
