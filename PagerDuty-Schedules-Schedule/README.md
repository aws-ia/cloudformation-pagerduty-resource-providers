...
1. Write the JSON schema describing your resource, [pagerduty-schedules-schedule.json](./pagerduty-schedules-schedule.json)
2. Implement your resource handlers in [handlers.ts](./pagerduty-schedules-schedule/handlers.ts)

> Don't modify [models.ts](./pagerduty-schedules-schedule/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
